...
if [ ${OS} == "Darwin" ]; then
	...
	if [ ${ARCH} == "arm" ]; then
		...
		install_tool_from_zipfile "kubeone" "kubeone" "https://github.com/kubermatic/kubeone/releases/download/v1.6.1/kubeone_1.6.1_darwin_arm64.zip" "caad36ea534741204abc7bc13e97b3744676ebab6885cc30c87be9eef6d53138"
	...
	install_tool_from_zipfile "kubeone" "kubeone" "https://github.com/kubermatic/kubeone/releases/download/v1.6.1/kubeone_1.6.1_linux_amd64.zip" "d4df1bd4581988837567ae881808cb8b92b5fde38de8794e251562766cd24ccb"
